...
/**
 * A class that can contribute information about the URLAvailabilityAgent to 
 * any support bundle that is generated.
 */
public class URLAvailabilityAgentSupportBundle implements SupportBundleListener2 {

/** A reference to the main agent class so we can collect information from it */
private final URLAvailabilityAgentImpl mAgent;

/**
 * Creates a new suypport bundle contributor.
 * @param agent
 */
public URLAvailabilityAgentSupportBundle(URLAvailabilityAgentImpl agent) {
    mAgent = agent;
}
...
public String getSuggestedLocation() { 
    return "URLAvailabilityAgent" + File.separator + "metric-count.txt";
}
...
public String getCollectorName() {
    return "URLAvailabilityAgent metric counts";
}
...
public void collectText(OutputStream output, SupportBundleLogger logger) throws Exception {
    ...
    out.println("The URLAvailabilityAgent has collected mAgent.getNumSamplesSent() samples");
}
