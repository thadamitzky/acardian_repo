 ...
 * the HostDiscoveryData topology object.
 * <p/>
...
public class HostDiscoveryData
    extends CollectionModelRoot
{

    public final static String NODE_NAME = "HostDiscoveryData";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;
    private Host _host;

    public HostDiscoveryData(String name) {
        ...
        throws TopologyException
    {
        ...
        if (!(_host == null)) {
            ...
            if (submitted.contains(_host.__getNodeId())) {
                ...
                final TopologyObject cloned = ((TopologyObject) _host.__cloneIdOnly());
                _node8 .setTypeHint(cloned.__getNodeName());
                _node8 .setId(cloned.__getNodeId().toString());
                cloned.addToNodeTree(_node8, unitService, submitted);
            } else {
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("HostDiscoveryData");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new HostDiscoveryData(getName());
    }
