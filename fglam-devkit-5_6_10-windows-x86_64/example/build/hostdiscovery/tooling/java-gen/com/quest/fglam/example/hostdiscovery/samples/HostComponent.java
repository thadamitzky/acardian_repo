    ...
    extends HostBaseObject
{
        ...
        throws TopologyException
    {
        ...
        if (!(_host == null)) {
            final TopologyNode _node78 = currentNode.createNode("host");
            ...
            if (submitted.contains(_host.__getNodeId())) {
                ...
                _node78 .setRefId(_host.__getNodeId().toString());
            } else {
                // Not already submitted, send the entire thing
                _node78 .setTypeHint(_host.__getNodeName());
                _node78 .setId(_host.__getNodeId().toString());
                _host.addToNodeTree(_node78, unitService, submitted);
            }
        }
    }
