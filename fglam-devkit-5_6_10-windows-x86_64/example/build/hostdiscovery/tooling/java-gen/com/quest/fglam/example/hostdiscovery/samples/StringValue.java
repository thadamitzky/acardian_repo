 ...
 * the StringValue topology object.
 * <p/>
    ...
    extends ObservedValue
{
    ...
    public final static String NODE_NAME = "StringValue";
        ...
        throws TopologyException
    {
        ...
        if (!(_value == null)) {
            final TopologyValue _value123 = currentNode.createValue("value");
            _value123 .setSampleValue(_value.toString());
            if (__isIdentity("value")) {
