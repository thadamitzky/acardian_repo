    ...
    extends DataObject
{
        ...
        throws TopologyException
    {
        ...
        if (!(_pid == null)) {
            final TopologyValue _value62 = currentNode.createValue("pid");
            _value62 .setSampleValue(_pid.toString());
            if (__isIdentity("pid")) {
                _value62 .setIsIdentity(true);
            }
        }
        if (!(_parentPid == null)) {
            final TopologyValue _value63 = currentNode.createValue("parentPid");
            _value63 .setSampleValue(_parentPid.toString());
            if (__isIdentity("parentPid")) {
                _value63 .setIsIdentity(true);
            }
        }
        if (!(_process == null)) {
            final TopologyNode _node64 = currentNode.createNode("process");
            ...
            if (submitted.contains(_process.__getNodeId())) {
                ...
                _node64 .setRefId(_process.__getNodeId().toString());
            } else {
                // Not already submitted, send the entire thing
                _node64 .setTypeHint(_process.__getNodeName());
                _node64 .setId(_process.__getNodeId().toString());
                _process.addToNodeTree(_node64, unitService, submitted);
            }
        }
        if (!(_percentProcessorTime == null)) {
            final TopologyValue _value65 = currentNode.createValue("percentProcessorTime");
            _value65 .setSampleValue(_percentProcessorTime, unitService.getUnits("percent"));
            if (__isIdentity("percentProcessorTime")) {
                _value65 .setIsIdentity(true);
            }
        }
        if (!(_totalProcessorTime == null)) {
            final TopologyValue _value66 = currentNode.createValue("totalProcessorTime");
            _value66 .setSampleValue(_totalProcessorTime, unitService.getUnits("second"));
            if (__isIdentity("totalProcessorTime")) {
                _value66 .setIsIdentity(true);
            }
        }
        if (!(_percentMemory == null)) {
            final TopologyValue _value67 = currentNode.createValue("percentMemory");
            _value67 .setSampleValue(_percentMemory, unitService.getUnits("percent"));
            if (__isIdentity("percentMemory")) {
                _value67 .setIsIdentity(true);
            }
        }
        if (!(_virtualSize == null)) {
            final TopologyValue _value68 = currentNode.createValue("virtualSize");
            _value68 .setSampleValue(_virtualSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("virtualSize")) {
                _value68 .setIsIdentity(true);
            }
        }
        if (!(_workingSetSize == null)) {
            final TopologyValue _value69 = currentNode.createValue("workingSetSize");
            _value69 .setSampleValue(_workingSetSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("workingSetSize")) {
                _value69 .setIsIdentity(true);
            }
        }
        if (!(_swapSize == null)) {
            final TopologyValue _value70 = currentNode.createValue("swapSize");
            _value70 .setSampleValue(_swapSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("swapSize")) {
                _value70 .setIsIdentity(true);
            }
        }
        if (!(_pageFaults == null)) {
            final TopologyValue _value71 = currentNode.createValue("pageFaults");
            _value71 .setSampleValue(_pageFaults, unitService.getUnits("count/second"));
            if (__isIdentity("pageFaults")) {
                _value71 .setIsIdentity(true);
            }
        }
        if (!(_dataRead == null)) {
            final TopologyValue _value72 = currentNode.createValue("dataRead");
            _value72 .setSampleValue(_dataRead, unitService.getUnits("byte/second"));
            if (__isIdentity("dataRead")) {
                _value72 .setIsIdentity(true);
            }
        }
        if (!(_dataWritten == null)) {
            final TopologyValue _value73 = currentNode.createValue("dataWritten");
            _value73 .setSampleValue(_dataWritten, unitService.getUnits("byte/second"));
            if (__isIdentity("dataWritten")) {
                _value73 .setIsIdentity(true);
            }
        }
        if (!(_dataOther == null)) {
            final TopologyValue _value74 = currentNode.createValue("dataOther");
            _value74 .setSampleValue(_dataOther, unitService.getUnits("byte/second"));
            if (__isIdentity("dataOther")) {
                _value74 .setIsIdentity(true);
            }
        }
        if (!(_operationsRead == null)) {
            final TopologyValue _value75 = currentNode.createValue("operationsRead");
            _value75 .setSampleValue(_operationsRead, unitService.getUnits("count/second"));
            if (__isIdentity("operationsRead")) {
                _value75 .setIsIdentity(true);
            }
        }
        if (!(_operationsWrite == null)) {
            final TopologyValue _value76 = currentNode.createValue("operationsWrite");
            _value76 .setSampleValue(_operationsWrite, unitService.getUnits("count/second"));
            if (__isIdentity("operationsWrite")) {
                _value76 .setIsIdentity(true);
            }
        }
        if (!(_operationsOther == null)) {
            final TopologyValue _value77 = currentNode.createValue("operationsOther");
            _value77 .setSampleValue(_operationsOther, unitService.getUnits("count/second"));
            if (__isIdentity("operationsOther")) {
                _value77 .setIsIdentity(true);
            }
        }
    }
