    ...
    extends HostBaseObject
{
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value175 = currentNode.createValue("name");
            _value175 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value175 .setIsIdentity(true);
            }
        }
        if (!(_os == null)) {
            final TopologyNode _node176 = currentNode.createNode("os");
            if (__isIdentity("os")) {
                _node176 .setIsIdentity(true);
            }
            if (submitted.contains(_os.__getNodeId())) {
                // field already submitted, just set the reference ID
                _node176 .setRefId(_os.__getNodeId().toString());
            } else {
                // Not already submitted, send the entire thing
                _node176 .setTypeHint(_os.__getNodeName());
                _node176 .setId(_os.__getNodeId().toString());
                _os.addToNodeTree(_node176, unitService, submitted);
            }
        }
        if (!(_percentProcessorTime == null)) {
            final TopologyNode _node177 = currentNode.createNode("percentProcessorTime");
            _percentProcessorTime.submit(_node177, unitService.getUnits("percent"));
        }
        if (!(_totalProcessorTime == null)) {
            final TopologyNode _node178 = currentNode.createNode("totalProcessorTime");
            _totalProcessorTime.submit(_node178, unitService.getUnits("second"));
        }
        if (!(_percentMemory == null)) {
            final TopologyNode _node179 = currentNode.createNode("percentMemory");
            _percentMemory.submit(_node179, unitService.getUnits("percent"));
        }
        if (!(_virtualSize == null)) {
            final TopologyNode _node180 = currentNode.createNode("virtualSize");
            _virtualSize.submit(_node180, unitService.getUnits("kilobyte"));
        }
        if (!(_workingSetSize == null)) {
            final TopologyNode _node181 = currentNode.createNode("workingSetSize");
            _workingSetSize.submit(_node181, unitService.getUnits("kilobyte"));
        }
        if (!(_swapSize == null)) {
            final TopologyNode _node182 = currentNode.createNode("swapSize");
            _swapSize.submit(_node182, unitService.getUnits("kilobyte"));
        }
        if (!(_pageFaults == null)) {
            final TopologyNode _node183 = currentNode.createNode("pageFaults");
            _pageFaults.submit(_node183, unitService.getUnits("count/second"));
        }
        if (!(_dataRead == null)) {
            final TopologyNode _node184 = currentNode.createNode("dataRead");
            _dataRead.submit(_node184, unitService.getUnits("byte/second"));
        }
        if (!(_dataWritten == null)) {
            final TopologyNode _node185 = currentNode.createNode("dataWritten");
            _dataWritten.submit(_node185, unitService.getUnits("byte/second"));
        }
        if (!(_dataOther == null)) {
            final TopologyNode _node186 = currentNode.createNode("dataOther");
            _dataOther.submit(_node186, unitService.getUnits("byte/second"));
        }
        if (!(_dataTransferRate == null)) {
            final TopologyNode _node187 = currentNode.createNode("dataTransferRate");
            _dataTransferRate.submit(_node187, unitService.getUnits("byte/second"));
        }
        if (!(_operationsRead == null)) {
            final TopologyNode _node188 = currentNode.createNode("operationsRead");
            _operationsRead.submit(_node188, unitService.getUnits("count/second"));
        }
        if (!(_operationsWrite == null)) {
            final TopologyNode _node189 = currentNode.createNode("operationsWrite");
            _operationsWrite.submit(_node189, unitService.getUnits("count/second"));
        }
        if (!(_operationsOther == null)) {
            final TopologyNode _node190 = currentNode.createNode("operationsOther");
            _operationsOther.submit(_node190, unitService.getUnits("count/second"));
        }
        if (!(_instances == null)) {
            for (TopologyObject list_element: _instances) {
                final TopologyNode _node191 = currentNode.createNode("instances");
                if (__isIdentity("instances")) {
                    _node191 .setIsIdentity(true);
                }
                if (submitted.contains(list_element.__getNodeId())) {
                    ...
                    _node191 .setTypeHint(cloned.__getNodeName());
                    _node191 .setId(cloned.__getNodeId().toString());
                    cloned.addToNodeTree(_node191, unitService, submitted);
                } else {
                    // Not already submitted, send the entire thing
                    _node191 .setTypeHint(list_element.__getNodeName());
                    _node191 .setId(list_element.__getNodeId().toString());
                    list_element.addToNodeTree(_node191, unitService, submitted);
                }
            }
        }
    }
