    ...
    extends HostTopProcessEntry
{
        ...
        throws TopologyException
    {
        ...
        if (!(_residentSetSize == null)) {
            final TopologyValue _value34 = currentNode.createValue("residentSetSize");
            _value34 .setSampleValue(_residentSetSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("residentSetSize")) {
                _value34 .setIsIdentity(true);
            }
        }
        if (!(_virtualSetSize == null)) {
            final TopologyValue _value35 = currentNode.createValue("virtualSetSize");
            _value35 .setSampleValue(_virtualSetSize, unitService.getUnits("kilobyte"));
