    ...
    extends HostComponent
{
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value197 = currentNode.createValue("name");
            _value197 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value197 .setIsIdentity(true);
            }
        }
        if (!(_utilization == null)) {
            final TopologyNode _node198 = currentNode.createNode("utilization");
            _utilization.submit(_node198, unitService.getUnits("percent"));
        }
        if (!(_reads == null)) {
            final TopologyNode _node199 = currentNode.createNode("reads");
            _reads.submit(_node199, unitService.getUnits("count/second"));
        }
        if (!(_writes == null)) {
            final TopologyNode _node200 = currentNode.createNode("writes");
            _writes.submit(_node200, unitService.getUnits("count/second"));
        }
        if (!(_bytesRead == null)) {
            final TopologyNode _node201 = currentNode.createNode("bytesRead");
            _bytesRead.submit(_node201, unitService.getUnits("kilobyte/second"));
        }
        if (!(_bytesWritten == null)) {
            final TopologyNode _node202 = currentNode.createNode("bytesWritten");
            _bytesWritten.submit(_node202, unitService.getUnits("kilobyte/second"));
        }
        if (!(_averageReadTime == null)) {
            final TopologyNode _node203 = currentNode.createNode("averageReadTime");
            _averageReadTime.submit(_node203, unitService.getUnits("millisecond"));
        }
        if (!(_averageWriteTime == null)) {
            final TopologyNode _node204 = currentNode.createNode("averageWriteTime");
            _averageWriteTime.submit(_node204, unitService.getUnits("millisecond"));
        }
        if (!(_averageTransferTime == null)) {
            final TopologyNode _node205 = currentNode.createNode("averageTransferTime");
            _averageTransferTime.submit(_node205, unitService.getUnits("millisecond"));
        }
        if (!(_queueLength == null)) {
            final TopologyNode _node206 = currentNode.createNode("queueLength");
            _queueLength.submit(_node206, unitService.getUnits("count"));
        }
        if (!(_spaceUsed == null)) {
            final TopologyNode _node207 = currentNode.createNode("spaceUsed");
            _spaceUsed.submit(_node207, unitService.getUnits("megabyte"));
        }
        if (!(_spaceAvailable == null)) {
            final TopologyNode _node208 = currentNode.createNode("spaceAvailable");
            _spaceAvailable.submit(_node208, unitService.getUnits("megabyte"));
        }
        if (!(_totalSpace == null)) {
            final TopologyNode _node209 = currentNode.createNode("totalSpace");
            _totalSpace.submit(_node209, unitService.getUnits("megabyte"));
        }
        if (!(_capacityUsed == null)) {
            final TopologyNode _node210 = currentNode.createNode("capacityUsed");
            _capacityUsed.submit(_node210, unitService.getUnits("percent"));
        }
        if (!(_capacityAvailable == null)) {
            final TopologyNode _node211 = currentNode.createNode("capacityAvailable");
            _capacityAvailable.submit(_node211, unitService.getUnits("percent"));
        }
    }
