    ...
    extends HostComponent
{
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value50 = currentNode.createValue("name");
            _value50 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value50 .setIsIdentity(true);
            }
        }
        if (!(_processorType == null)) {
            final TopologyValue _value51 = currentNode.createValue("processorType");
            _value51 .setSampleValue(_processorType.toString());
            if (__isIdentity("processorType")) {
                _value51 .setIsIdentity(true);
            }
        }
        if (!(_stepping == null)) {
            final TopologyValue _value52 = currentNode.createValue("stepping");
            _value52 .setSampleValue(_stepping.toString());
            if (__isIdentity("stepping")) {
                _value52 .setIsIdentity(true);
            }
        }
        if (!(_percentUserTime == null)) {
            final TopologyNode _node53 = currentNode.createNode("percentUserTime");
            _percentUserTime.submit(_node53, unitService.getUnits("percent"));
        }
        if (!(_percentSystemTime == null)) {
            final TopologyNode _node54 = currentNode.createNode("percentSystemTime");
            _percentSystemTime.submit(_node54, unitService.getUnits("percent"));
        }
        if (!(_percentIdleTime == null)) {
            final TopologyNode _node55 = currentNode.createNode("percentIdleTime");
            _percentIdleTime.submit(_node55, unitService.getUnits("percent"));
        }
        if (!(_utilization == null)) {
            final TopologyNode _node56 = currentNode.createNode("utilization");
            _utilization.submit(_node56, unitService.getUnits("percent"));
        }
        if (!(_usedHz == null)) {
            final TopologyNode _node57 = currentNode.createNode("usedHz");
            _usedHz.submit(_node57, unitService.getUnits("count"));
        }
        if (!(_totalHz == null)) {
            final TopologyNode _node58 = currentNode.createNode("totalHz");
            _totalHz.submit(_node58, unitService.getUnits("count"));
        }
    }
