    ...
    extends CollectionModelInstance
{
    ...
    private com.quest.fglam.example.url.samples.IPAddress _primaryIpAddress;
    ...
    public void reset() {
        ...
        if (!(_ipAddresses == null)) {
            for (com.quest.fglam.example.url.samples.TopologyObject list_element: _ipAddresses) {
                list_element.reset();
            }
        }
        if (!(_running == null)) {
            for (com.quest.fglam.example.url.samples.TopologyObject list_element: _running) {
                list_element.reset();
            }
        }
        if (!(_detail == null)) {
            for (com.quest.fglam.example.url.samples.TopologyObject list_element: _detail) {
                list_element.reset();
            }
        }
        if (!(_agents == null)) {
            for (com.quest.fglam.example.url.samples.TopologyObject list_element: _agents) {
                list_element.reset();
            }
        }
        _isHidden = null;
        ...
        if (!(_virtualHosts == null)) {
            for (com.quest.fglam.example.url.samples.TopologyObject list_element: _virtualHosts) {
                list_element.reset();
            }
        }
    ...
    public boolean equals(java.lang.Object _obj) {
        if ((!(_obj == null))&&(_obj instanceof com.quest.fglam.example.url.samples.TopologyObject)) {
            final com.quest.fglam.example.url.samples.TopologyObject _otherObject = ((com.quest.fglam.example.url.samples.TopologyObject) _obj);
     ...
     */
    public com.quest.fglam.example.url.samples.IPAddress getPrimaryIpAddress() {
     ...
     * 
     */
    public void setPrimaryIpAddress(com.quest.fglam.example.url.samples.IPAddress primaryIpAddress) {
    ...
    public void initialize(CommonTopologyInfo commonTopologyInfo, List<DnsResolvedHost> resolvedHostInfo) {
        ...
        if (primaryIPAddress!= null) {
            setPrimaryIpAddress(new com.quest.fglam.example.url.samples.IPAddress(primaryIPAddress));
        }
        for (DnsResolvedHost resHost: resolvedHostInfo) {
            for (InetAddress ip_address: resHost.getResolved()) {
                final com.quest.fglam.example.url.samples.IPAddress topo_ip_address = new com.quest.fglam.example.url.samples.IPAddress(ip_address.getHostAddress());
