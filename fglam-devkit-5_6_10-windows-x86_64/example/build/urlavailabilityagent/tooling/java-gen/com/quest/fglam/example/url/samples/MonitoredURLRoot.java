 ...
 * the MonitoredURLRoot topology object.
 * <p/>
...
public class MonitoredURLRoot
    extends CollectionModelRoot
{

    public final static String NODE_NAME = "MonitoredURLRoot";
    ...
    public MonitoredURLRoot(String name) {
        ...
        throws TopologyException
    {
        ...
        if (!(_instances == null)) {
            for (TopologyObject list_element: _instances) {
                final TopologyNode _node8 = currentNode.createNode("instances");
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("MonitoredURLRoot");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new MonitoredURLRoot(getName());
    }
