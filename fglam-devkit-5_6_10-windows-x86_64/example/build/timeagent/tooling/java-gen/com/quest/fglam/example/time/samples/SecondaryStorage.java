    ...
    extends HostComponent
{
        ...
        throws TopologyException
    {
        ...
        if (!(_utilization == null)) {
            final TopologyNode _node203 = currentNode.createNode("utilization");
            _utilization.submit(_node203, unitService.getUnits("percent"));
        }
        if (!(_reads == null)) {
            final TopologyNode _node204 = currentNode.createNode("reads");
            _reads.submit(_node204, unitService.getUnits("count/second"));
        }
        if (!(_writes == null)) {
            final TopologyNode _node205 = currentNode.createNode("writes");
            _writes.submit(_node205, unitService.getUnits("count/second"));
        }
        if (!(_bytesRead == null)) {
            final TopologyNode _node206 = currentNode.createNode("bytesRead");
            _bytesRead.submit(_node206, unitService.getUnits("kilobyte/second"));
        }
        if (!(_bytesWritten == null)) {
            final TopologyNode _node207 = currentNode.createNode("bytesWritten");
            _bytesWritten.submit(_node207, unitService.getUnits("kilobyte/second"));
        }
        if (!(_averageReadTime == null)) {
            final TopologyNode _node208 = currentNode.createNode("averageReadTime");
            _averageReadTime.submit(_node208, unitService.getUnits("millisecond"));
        }
        if (!(_averageWriteTime == null)) {
            final TopologyNode _node209 = currentNode.createNode("averageWriteTime");
            _averageWriteTime.submit(_node209, unitService.getUnits("millisecond"));
        }
        if (!(_averageTransferTime == null)) {
            final TopologyNode _node210 = currentNode.createNode("averageTransferTime");
            _averageTransferTime.submit(_node210, unitService.getUnits("millisecond"));
        }
        if (!(_queueLength == null)) {
            final TopologyNode _node211 = currentNode.createNode("queueLength");
            _queueLength.submit(_node211, unitService.getUnits("count"));
        }
        if (!(_spaceUsed == null)) {
            final TopologyNode _node212 = currentNode.createNode("spaceUsed");
            _spaceUsed.submit(_node212, unitService.getUnits("megabyte"));
        }
        if (!(_spaceAvailable == null)) {
            final TopologyNode _node213 = currentNode.createNode("spaceAvailable");
            _spaceAvailable.submit(_node213, unitService.getUnits("megabyte"));
        }
        if (!(_totalSpace == null)) {
            final TopologyNode _node214 = currentNode.createNode("totalSpace");
            _totalSpace.submit(_node214, unitService.getUnits("megabyte"));
        }
        if (!(_capacityUsed == null)) {
            final TopologyNode _node215 = currentNode.createNode("capacityUsed");
            _capacityUsed.submit(_node215, unitService.getUnits("percent"));
        }
        if (!(_capacityAvailable == null)) {
            final TopologyNode _node216 = currentNode.createNode("capacityAvailable");
            _capacityAvailable.submit(_node216, unitService.getUnits("percent"));
        }
    }
