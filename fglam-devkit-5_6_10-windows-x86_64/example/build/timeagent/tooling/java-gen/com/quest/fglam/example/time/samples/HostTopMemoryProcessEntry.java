    ...
    extends HostTopProcessEntry
{
        ...
        throws TopologyException
    {
        ...
        if (!(_residentSetSize == null)) {
            final TopologyValue _value43 = currentNode.createValue("residentSetSize");
            _value43 .setSampleValue(_residentSetSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("residentSetSize")) {
                _value43 .setIsIdentity(true);
            }
        }
        if (!(_virtualSetSize == null)) {
            final TopologyValue _value44 = currentNode.createValue("virtualSetSize");
            _value44 .setSampleValue(_virtualSetSize, unitService.getUnits("kilobyte"));
