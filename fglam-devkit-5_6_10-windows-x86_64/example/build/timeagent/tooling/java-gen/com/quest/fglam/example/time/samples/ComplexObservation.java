 ...
 * the ComplexObservation topology object.
 * <p/>
...
public class ComplexObservation
    extends Observation
{

    public final static String NODE_NAME = "ComplexObservation";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;

    public ComplexObservation() {
    }
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("ComplexObservation");
        builder.append("@");
