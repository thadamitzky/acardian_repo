 ...
 * the Observation topology object.
 * <p/>
    ...
    extends DataObject
{
    ...
    public final static String NODE_NAME = "Observation";
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value131 = currentNode.createValue("name");
            _value131 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value131 .setIsIdentity(true);
            }
        }
    }
