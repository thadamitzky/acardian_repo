    ...
    extends DataObject
{
        ...
        throws TopologyException
    {
        ...
        if (!(_pid == null)) {
            final TopologyValue _value71 = currentNode.createValue("pid");
            _value71 .setSampleValue(_pid.toString());
            if (__isIdentity("pid")) {
                _value71 .setIsIdentity(true);
            }
        }
        if (!(_parentPid == null)) {
            final TopologyValue _value72 = currentNode.createValue("parentPid");
            _value72 .setSampleValue(_parentPid.toString());
            if (__isIdentity("parentPid")) {
                _value72 .setIsIdentity(true);
            }
        }
        if (!(_process == null)) {
            final TopologyNode _node73 = currentNode.createNode("process");
            if (__isIdentity("process")) {
                _node73 .setIsIdentity(true);
            }
            if (submitted.contains(_process.__getNodeId())) {
                // field already submitted, just set the reference ID
                _node73 .setRefId(_process.__getNodeId().toString());
            } else {
                // Not already submitted, send the entire thing
                _node73 .setTypeHint(_process.__getNodeName());
                _node73 .setId(_process.__getNodeId().toString());
                _process.addToNodeTree(_node73, unitService, submitted);
            }
        }
        if (!(_percentProcessorTime == null)) {
            final TopologyValue _value74 = currentNode.createValue("percentProcessorTime");
            _value74 .setSampleValue(_percentProcessorTime, unitService.getUnits("percent"));
            if (__isIdentity("percentProcessorTime")) {
                _value74 .setIsIdentity(true);
            }
        }
        if (!(_totalProcessorTime == null)) {
            final TopologyValue _value75 = currentNode.createValue("totalProcessorTime");
            _value75 .setSampleValue(_totalProcessorTime, unitService.getUnits("second"));
            if (__isIdentity("totalProcessorTime")) {
                _value75 .setIsIdentity(true);
            }
        }
        if (!(_percentMemory == null)) {
            final TopologyValue _value76 = currentNode.createValue("percentMemory");
            _value76 .setSampleValue(_percentMemory, unitService.getUnits("percent"));
            if (__isIdentity("percentMemory")) {
                _value76 .setIsIdentity(true);
            }
        }
        if (!(_virtualSize == null)) {
            final TopologyValue _value77 = currentNode.createValue("virtualSize");
            _value77 .setSampleValue(_virtualSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("virtualSize")) {
                _value77 .setIsIdentity(true);
            }
        }
        if (!(_workingSetSize == null)) {
            final TopologyValue _value78 = currentNode.createValue("workingSetSize");
            _value78 .setSampleValue(_workingSetSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("workingSetSize")) {
                _value78 .setIsIdentity(true);
            }
        }
        if (!(_swapSize == null)) {
            final TopologyValue _value79 = currentNode.createValue("swapSize");
            _value79 .setSampleValue(_swapSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("swapSize")) {
                _value79 .setIsIdentity(true);
            }
        }
        if (!(_pageFaults == null)) {
            final TopologyValue _value80 = currentNode.createValue("pageFaults");
            _value80 .setSampleValue(_pageFaults, unitService.getUnits("count/second"));
            if (__isIdentity("pageFaults")) {
                _value80 .setIsIdentity(true);
            }
        }
        if (!(_dataRead == null)) {
            final TopologyValue _value81 = currentNode.createValue("dataRead");
            _value81 .setSampleValue(_dataRead, unitService.getUnits("byte/second"));
            if (__isIdentity("dataRead")) {
                _value81 .setIsIdentity(true);
            }
        }
        if (!(_dataWritten == null)) {
            final TopologyValue _value82 = currentNode.createValue("dataWritten");
            _value82 .setSampleValue(_dataWritten, unitService.getUnits("byte/second"));
            if (__isIdentity("dataWritten")) {
                _value82 .setIsIdentity(true);
            }
        }
        if (!(_dataOther == null)) {
            final TopologyValue _value83 = currentNode.createValue("dataOther");
            _value83 .setSampleValue(_dataOther, unitService.getUnits("byte/second"));
            if (__isIdentity("dataOther")) {
                _value83 .setIsIdentity(true);
            }
        }
        if (!(_operationsRead == null)) {
            final TopologyValue _value84 = currentNode.createValue("operationsRead");
            _value84 .setSampleValue(_operationsRead, unitService.getUnits("count/second"));
            if (__isIdentity("operationsRead")) {
                _value84 .setIsIdentity(true);
            }
        }
        if (!(_operationsWrite == null)) {
            final TopologyValue _value85 = currentNode.createValue("operationsWrite");
            _value85 .setSampleValue(_operationsWrite, unitService.getUnits("count/second"));
            if (__isIdentity("operationsWrite")) {
                _value85 .setIsIdentity(true);
            }
        }
        if (!(_operationsOther == null)) {
            final TopologyValue _value86 = currentNode.createValue("operationsOther");
            _value86 .setSampleValue(_operationsOther, unitService.getUnits("count/second"));
