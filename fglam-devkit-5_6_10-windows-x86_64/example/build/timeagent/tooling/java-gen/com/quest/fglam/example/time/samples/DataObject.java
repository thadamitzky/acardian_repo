...
public class DataObject
    extends com.quest.fglam.example.time.samples.Object
{
        ...
        throws TopologyException
    {
        ...
        if (!(_uniqueId == null)) {
            final TopologyValue _value219 = currentNode.createValue("uniqueId");
            _value219 .setSampleValue(_uniqueId.toString());
