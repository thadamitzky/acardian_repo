    ...
    extends HostComponent
{
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value59 = currentNode.createValue("name");
            _value59 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value59 .setIsIdentity(true);
            }
        }
        if (!(_processorType == null)) {
            final TopologyValue _value60 = currentNode.createValue("processorType");
            _value60 .setSampleValue(_processorType.toString());
            if (__isIdentity("processorType")) {
                _value60 .setIsIdentity(true);
            }
        }
        if (!(_stepping == null)) {
            final TopologyValue _value61 = currentNode.createValue("stepping");
            _value61 .setSampleValue(_stepping.toString());
            if (__isIdentity("stepping")) {
                _value61 .setIsIdentity(true);
            }
        }
        if (!(_percentUserTime == null)) {
            final TopologyNode _node62 = currentNode.createNode("percentUserTime");
            _percentUserTime.submit(_node62, unitService.getUnits("percent"));
        }
        if (!(_percentSystemTime == null)) {
            final TopologyNode _node63 = currentNode.createNode("percentSystemTime");
            _percentSystemTime.submit(_node63, unitService.getUnits("percent"));
        }
        if (!(_percentIdleTime == null)) {
            final TopologyNode _node64 = currentNode.createNode("percentIdleTime");
            _percentIdleTime.submit(_node64, unitService.getUnits("percent"));
        }
        if (!(_utilization == null)) {
            final TopologyNode _node65 = currentNode.createNode("utilization");
            _utilization.submit(_node65, unitService.getUnits("percent"));
        }
        if (!(_usedHz == null)) {
            final TopologyNode _node66 = currentNode.createNode("usedHz");
            _usedHz.submit(_node66, unitService.getUnits("count"));
        }
        if (!(_totalHz == null)) {
            final TopologyNode _node67 = currentNode.createNode("totalHz");
            _totalHz.submit(_node67, unitService.getUnits("count"));
        }
    }
