 ...
 * the EnumObservedValue topology object.
 * <p/>
...
public class EnumObservedValue
    extends ObservedValue
{

    public final static String NODE_NAME = "EnumObservedValue";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;

    public EnumObservedValue() {
    }
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("EnumObservedValue");
        builder.append("@");
