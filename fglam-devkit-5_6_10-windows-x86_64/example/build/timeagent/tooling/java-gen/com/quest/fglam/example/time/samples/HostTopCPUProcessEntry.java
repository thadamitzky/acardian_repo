    ...
    extends HostTopProcessEntry
{
        ...
        throws TopologyException
    {
        ...
        if (!(_cpuUsage == null)) {
            final TopologyValue _value132 = currentNode.createValue("cpuUsage");
            _value132 .setSampleValue(_cpuUsage, unitService.getUnits("percent"));
            if (__isIdentity("cpuUsage")) {
                _value132 .setIsIdentity(true);
            }
        }
    }
