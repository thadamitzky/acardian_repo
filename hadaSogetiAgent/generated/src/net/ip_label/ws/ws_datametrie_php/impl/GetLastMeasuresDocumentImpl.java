 ...
 */
public class GetLastMeasuresDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument
{
    
    public GetLastMeasuresDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETLASTMEASURES$0 = 
        new javax.xml.namespace.QName("https://ws.ip-label.net/WS_datametrie.php", "Get_Last_Measures");
    
    
    /**
     * Gets the "Get_Last_Measures" element
     */
    public net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument.GetLastMeasures getGetLastMeasures()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument.GetLastMeasures target = null;
            target = (net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument.GetLastMeasures)get_store().find_element_user(GETLASTMEASURES$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetLastMeasures(net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument.GetLastMeasures getLastMeasures)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument.GetLastMeasures)get_store().add_element_user(GETLASTMEASURES$0);
            }
            target.set(getLastMeasures);
        }
    }
     ...
     */
    public net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument.GetLastMeasures addNewGetLastMeasures()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetLastMeasuresImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.ip_label.ws.ws_datametrie_php.GetLastMeasuresDocument.GetLastMeasures
    {
        
        public GetLastMeasuresImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
