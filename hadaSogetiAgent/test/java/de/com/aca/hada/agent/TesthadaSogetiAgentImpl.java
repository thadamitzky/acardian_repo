...
/**
 * This class contains the unit tests for the hadaSogetiAgent agent. Although the agent 
 ...
 */
public class TesthadaSogetiAgentImpl {

private hadaSogetiAgentImpl mAgent;
...
public void initTest() throws ServiceFactory.ServiceNotAvailableException {
    ...
    mAgent = new hadaSogetiAgentImpl(serviceFactory, mMockProvider);
}
 ...
 * provide a mockup of the {@link hadaSogetiAgentDataProvider} interface.
 */
private static final class MockDataProvider implements hadaSogetiAgentDataProvider {
