    ...
    extends DataObject
{
        ...
        throws TopologyException
    {
        ...
        if (!(_pid == null)) {
            final TopologyValue _value209 = currentNode.createValue("pid");
            _value209 .setSampleValue(_pid.toString());
            if (__isIdentity("pid")) {
                _value209 .setIsIdentity(true);
            }
        }
        if (!(_parentPid == null)) {
            final TopologyValue _value210 = currentNode.createValue("parentPid");
            _value210 .setSampleValue(_parentPid.toString());
            if (__isIdentity("parentPid")) {
                _value210 .setIsIdentity(true);
            }
        }
        if (!(_process == null)) {
            final TopologyNode _node211 = currentNode.createNode("process");
            if (__isIdentity("process")) {
                _node211 .setIsIdentity(true);
            }
            if (submitted.contains(_process.__getNodeId())) {
                // field already submitted, just set the reference ID
                _node211 .setRefId(_process.__getNodeId().toString());
            } else {
                // Not already submitted, send the entire thing
                _node211 .setTypeHint(_process.__getNodeName());
                _node211 .setId(_process.__getNodeId().toString());
                _process.addToNodeTree(_node211, unitService, submitted);
            }
        }
        if (!(_percentProcessorTime == null)) {
            final TopologyValue _value212 = currentNode.createValue("percentProcessorTime");
            _value212 .setSampleValue(_percentProcessorTime, unitService.getUnits("percent"));
            if (__isIdentity("percentProcessorTime")) {
                _value212 .setIsIdentity(true);
            }
        }
        if (!(_totalProcessorTime == null)) {
            final TopologyValue _value213 = currentNode.createValue("totalProcessorTime");
            _value213 .setSampleValue(_totalProcessorTime, unitService.getUnits("second"));
            if (__isIdentity("totalProcessorTime")) {
                _value213 .setIsIdentity(true);
            }
        }
        if (!(_percentMemory == null)) {
            final TopologyValue _value214 = currentNode.createValue("percentMemory");
            _value214 .setSampleValue(_percentMemory, unitService.getUnits("percent"));
            if (__isIdentity("percentMemory")) {
                _value214 .setIsIdentity(true);
            }
        }
        if (!(_virtualSize == null)) {
            final TopologyValue _value215 = currentNode.createValue("virtualSize");
            _value215 .setSampleValue(_virtualSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("virtualSize")) {
                _value215 .setIsIdentity(true);
            }
        }
        if (!(_workingSetSize == null)) {
            final TopologyValue _value216 = currentNode.createValue("workingSetSize");
            _value216 .setSampleValue(_workingSetSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("workingSetSize")) {
                _value216 .setIsIdentity(true);
            }
        }
        if (!(_swapSize == null)) {
            final TopologyValue _value217 = currentNode.createValue("swapSize");
            _value217 .setSampleValue(_swapSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("swapSize")) {
                _value217 .setIsIdentity(true);
            }
        }
        if (!(_pageFaults == null)) {
            final TopologyValue _value218 = currentNode.createValue("pageFaults");
            _value218 .setSampleValue(_pageFaults, unitService.getUnits("count/second"));
            if (__isIdentity("pageFaults")) {
                _value218 .setIsIdentity(true);
            }
        }
        if (!(_dataRead == null)) {
            final TopologyValue _value219 = currentNode.createValue("dataRead");
            _value219 .setSampleValue(_dataRead, unitService.getUnits("byte/second"));
            if (__isIdentity("dataRead")) {
                _value219 .setIsIdentity(true);
            }
        }
        if (!(_dataWritten == null)) {
            final TopologyValue _value220 = currentNode.createValue("dataWritten");
            _value220 .setSampleValue(_dataWritten, unitService.getUnits("byte/second"));
            if (__isIdentity("dataWritten")) {
                _value220 .setIsIdentity(true);
            }
        }
        if (!(_dataOther == null)) {
            final TopologyValue _value221 = currentNode.createValue("dataOther");
            _value221 .setSampleValue(_dataOther, unitService.getUnits("byte/second"));
            if (__isIdentity("dataOther")) {
                _value221 .setIsIdentity(true);
            }
        }
        if (!(_operationsRead == null)) {
            final TopologyValue _value222 = currentNode.createValue("operationsRead");
            _value222 .setSampleValue(_operationsRead, unitService.getUnits("count/second"));
            if (__isIdentity("operationsRead")) {
                _value222 .setIsIdentity(true);
            }
        }
        if (!(_operationsWrite == null)) {
            final TopologyValue _value223 = currentNode.createValue("operationsWrite");
            _value223 .setSampleValue(_operationsWrite, unitService.getUnits("count/second"));
            if (__isIdentity("operationsWrite")) {
                _value223 .setIsIdentity(true);
            }
        }
        if (!(_operationsOther == null)) {
            final TopologyValue _value224 = currentNode.createValue("operationsOther");
            _value224 .setSampleValue(_operationsOther, unitService.getUnits("count/second"));
            if (__isIdentity("operationsOther")) {
                _value224 .setIsIdentity(true);
            }
        }
    }
