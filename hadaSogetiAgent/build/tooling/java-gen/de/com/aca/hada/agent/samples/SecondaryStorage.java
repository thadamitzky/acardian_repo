    ...
    extends HostComponent
{
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value181 = currentNode.createValue("name");
            _value181 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value181 .setIsIdentity(true);
            }
        }
        if (!(_utilization == null)) {
            final TopologyNode _node182 = currentNode.createNode("utilization");
            _utilization.submit(_node182, unitService.getUnits("percent"));
        }
        if (!(_reads == null)) {
            final TopologyNode _node183 = currentNode.createNode("reads");
            _reads.submit(_node183, unitService.getUnits("count/second"));
        }
        if (!(_writes == null)) {
            final TopologyNode _node184 = currentNode.createNode("writes");
            _writes.submit(_node184, unitService.getUnits("count/second"));
        }
        if (!(_bytesRead == null)) {
            final TopologyNode _node185 = currentNode.createNode("bytesRead");
            _bytesRead.submit(_node185, unitService.getUnits("kilobyte/second"));
        }
        if (!(_bytesWritten == null)) {
            final TopologyNode _node186 = currentNode.createNode("bytesWritten");
            _bytesWritten.submit(_node186, unitService.getUnits("kilobyte/second"));
        }
        if (!(_averageReadTime == null)) {
            final TopologyNode _node187 = currentNode.createNode("averageReadTime");
            _averageReadTime.submit(_node187, unitService.getUnits("millisecond"));
        }
        if (!(_averageWriteTime == null)) {
            final TopologyNode _node188 = currentNode.createNode("averageWriteTime");
            _averageWriteTime.submit(_node188, unitService.getUnits("millisecond"));
        }
        if (!(_averageTransferTime == null)) {
            final TopologyNode _node189 = currentNode.createNode("averageTransferTime");
            _averageTransferTime.submit(_node189, unitService.getUnits("millisecond"));
        }
        if (!(_queueLength == null)) {
            final TopologyNode _node190 = currentNode.createNode("queueLength");
            _queueLength.submit(_node190, unitService.getUnits("count"));
        }
        if (!(_spaceUsed == null)) {
            final TopologyNode _node191 = currentNode.createNode("spaceUsed");
            _spaceUsed.submit(_node191, unitService.getUnits("megabyte"));
        }
        if (!(_spaceAvailable == null)) {
            final TopologyNode _node192 = currentNode.createNode("spaceAvailable");
            _spaceAvailable.submit(_node192, unitService.getUnits("megabyte"));
        }
        if (!(_totalSpace == null)) {
            final TopologyNode _node193 = currentNode.createNode("totalSpace");
            _totalSpace.submit(_node193, unitService.getUnits("megabyte"));
        }
        if (!(_capacityUsed == null)) {
            final TopologyNode _node194 = currentNode.createNode("capacityUsed");
            _capacityUsed.submit(_node194, unitService.getUnits("percent"));
        }
        if (!(_capacityAvailable == null)) {
            final TopologyNode _node195 = currentNode.createNode("capacityAvailable");
            _capacityAvailable.submit(_node195, unitService.getUnits("percent"));
        }
    }
