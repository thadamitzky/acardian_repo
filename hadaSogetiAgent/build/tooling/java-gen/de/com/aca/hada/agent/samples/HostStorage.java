    ...
    extends HostComponent
{
        ...
        throws TopologyException
    {
        ...
        if (!(_physicalDisks == null)) {
            for (TopologyObject list_element: _physicalDisks) {
                final TopologyNode _node141 = currentNode.createNode("physicalDisks");
        ...
        if (!(_logicalDisks == null)) {
            for (TopologyObject list_element: _logicalDisks) {
                final TopologyNode _node142 = currentNode.createNode("logicalDisks");
        ...
        if (!(_diskUtilization == null)) {
            final TopologyNode _node143 = currentNode.createNode("diskUtilization");
            _diskUtilization.submit(_node143, unitService.getUnits("percent"));
        }
        if (!(_diskReads == null)) {
            final TopologyNode _node144 = currentNode.createNode("diskReads");
            _diskReads.submit(_node144, unitService.getUnits("count/second"));
        }
        if (!(_diskWrites == null)) {
            final TopologyNode _node145 = currentNode.createNode("diskWrites");
            _diskWrites.submit(_node145, unitService.getUnits("count/second"));
        }
        if (!(_diskBytesRead == null)) {
            final TopologyNode _node146 = currentNode.createNode("diskBytesRead");
            _diskBytesRead.submit(_node146, unitService.getUnits("kilobyte/second"));
        }
        if (!(_diskBytesWritten == null)) {
            final TopologyNode _node147 = currentNode.createNode("diskBytesWritten");
            _diskBytesWritten.submit(_node147, unitService.getUnits("kilobyte/second"));
        }
        if (!(_diskTransferRate == null)) {
            final TopologyNode _node148 = currentNode.createNode("diskTransferRate");
            _diskTransferRate.submit(_node148, unitService.getUnits("kilobyte/second"));
        }
        if (!(_spaceUsed == null)) {
            final TopologyNode _node149 = currentNode.createNode("spaceUsed");
            _spaceUsed.submit(_node149, unitService.getUnits("megabyte"));
        }
        if (!(_spaceAvailable == null)) {
            final TopologyNode _node150 = currentNode.createNode("spaceAvailable");
            _spaceAvailable.submit(_node150, unitService.getUnits("megabyte"));
        }
        if (!(_topIOProcesses == null)) {
            for (TopologyObject list_element: _topIOProcesses) {
                final TopologyNode _node151 = currentNode.createNode("topIOProcesses");
                if (__isIdentity("topIOProcesses")) {
                    _node151 .setIsIdentity(true);
                }
                if (submitted.contains(list_element.__getNodeId())) {
                    ...
                    _node151 .setTypeHint(cloned.__getNodeName());
                    _node151 .setId(cloned.__getNodeId().toString());
                    cloned.addToNodeTree(_node151, unitService, submitted);
                } else {
                    // Not already submitted, send the entire thing
                    _node151 .setTypeHint(list_element.__getNodeName());
                    _node151 .setId(list_element.__getNodeId().toString());
                    list_element.addToNodeTree(_node151, unitService, submitted);
                }
            }
        }
    }
