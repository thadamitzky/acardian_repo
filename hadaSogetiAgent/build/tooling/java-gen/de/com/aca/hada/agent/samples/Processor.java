    ...
    extends HostComponent
{
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value199 = currentNode.createValue("name");
            _value199 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value199 .setIsIdentity(true);
            }
        }
        if (!(_processorType == null)) {
            final TopologyValue _value200 = currentNode.createValue("processorType");
            _value200 .setSampleValue(_processorType.toString());
            if (__isIdentity("processorType")) {
                _value200 .setIsIdentity(true);
            }
        }
        if (!(_stepping == null)) {
            final TopologyValue _value201 = currentNode.createValue("stepping");
            _value201 .setSampleValue(_stepping.toString());
            if (__isIdentity("stepping")) {
                _value201 .setIsIdentity(true);
            }
        }
        if (!(_percentUserTime == null)) {
            final TopologyNode _node202 = currentNode.createNode("percentUserTime");
            _percentUserTime.submit(_node202, unitService.getUnits("percent"));
        }
        if (!(_percentSystemTime == null)) {
            final TopologyNode _node203 = currentNode.createNode("percentSystemTime");
            _percentSystemTime.submit(_node203, unitService.getUnits("percent"));
        }
        if (!(_percentIdleTime == null)) {
            final TopologyNode _node204 = currentNode.createNode("percentIdleTime");
            _percentIdleTime.submit(_node204, unitService.getUnits("percent"));
        }
        ...
        if (!(_usedHz == null)) {
            final TopologyNode _node206 = currentNode.createNode("usedHz");
            _usedHz.submit(_node206, unitService.getUnits("count"));
        }
        if (!(_totalHz == null)) {
            final TopologyNode _node207 = currentNode.createNode("totalHz");
            _totalHz.submit(_node207, unitService.getUnits("count"));
        }
    }
