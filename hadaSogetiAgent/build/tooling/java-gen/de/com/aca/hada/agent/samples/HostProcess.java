    ...
    extends HostBaseObject
{
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value161 = currentNode.createValue("name");
            _value161 .setSampleValue(_name.toString());
            if (__isIdentity("name")) {
                _value161 .setIsIdentity(true);
            }
        }
        if (!(_os == null)) {
            final TopologyNode _node162 = currentNode.createNode("os");
            if (__isIdentity("os")) {
                _node162 .setIsIdentity(true);
            }
            if (submitted.contains(_os.__getNodeId())) {
                // field already submitted, just set the reference ID
                _node162 .setRefId(_os.__getNodeId().toString());
            } else {
                // Not already submitted, send the entire thing
                _node162 .setTypeHint(_os.__getNodeName());
                _node162 .setId(_os.__getNodeId().toString());
                _os.addToNodeTree(_node162, unitService, submitted);
            }
        }
        if (!(_percentProcessorTime == null)) {
            final TopologyNode _node163 = currentNode.createNode("percentProcessorTime");
            _percentProcessorTime.submit(_node163, unitService.getUnits("percent"));
        }
        if (!(_totalProcessorTime == null)) {
            final TopologyNode _node164 = currentNode.createNode("totalProcessorTime");
            _totalProcessorTime.submit(_node164, unitService.getUnits("second"));
        }
        if (!(_percentMemory == null)) {
            final TopologyNode _node165 = currentNode.createNode("percentMemory");
            _percentMemory.submit(_node165, unitService.getUnits("percent"));
        }
        if (!(_virtualSize == null)) {
            final TopologyNode _node166 = currentNode.createNode("virtualSize");
            _virtualSize.submit(_node166, unitService.getUnits("kilobyte"));
        }
        if (!(_workingSetSize == null)) {
            final TopologyNode _node167 = currentNode.createNode("workingSetSize");
            _workingSetSize.submit(_node167, unitService.getUnits("kilobyte"));
        }
        if (!(_swapSize == null)) {
            final TopologyNode _node168 = currentNode.createNode("swapSize");
            _swapSize.submit(_node168, unitService.getUnits("kilobyte"));
        }
        if (!(_pageFaults == null)) {
            final TopologyNode _node169 = currentNode.createNode("pageFaults");
            _pageFaults.submit(_node169, unitService.getUnits("count/second"));
        }
        if (!(_dataRead == null)) {
            final TopologyNode _node170 = currentNode.createNode("dataRead");
            _dataRead.submit(_node170, unitService.getUnits("byte/second"));
        }
        if (!(_dataWritten == null)) {
            final TopologyNode _node171 = currentNode.createNode("dataWritten");
            _dataWritten.submit(_node171, unitService.getUnits("byte/second"));
        }
        if (!(_dataOther == null)) {
            final TopologyNode _node172 = currentNode.createNode("dataOther");
            _dataOther.submit(_node172, unitService.getUnits("byte/second"));
        }
        if (!(_dataTransferRate == null)) {
            final TopologyNode _node173 = currentNode.createNode("dataTransferRate");
            _dataTransferRate.submit(_node173, unitService.getUnits("byte/second"));
        }
        if (!(_operationsRead == null)) {
            final TopologyNode _node174 = currentNode.createNode("operationsRead");
            _operationsRead.submit(_node174, unitService.getUnits("count/second"));
        }
        if (!(_operationsWrite == null)) {
            final TopologyNode _node175 = currentNode.createNode("operationsWrite");
            _operationsWrite.submit(_node175, unitService.getUnits("count/second"));
        }
        if (!(_operationsOther == null)) {
            final TopologyNode _node176 = currentNode.createNode("operationsOther");
            _operationsOther.submit(_node176, unitService.getUnits("count/second"));
        }
        if (!(_instances == null)) {
            for (TopologyObject list_element: _instances) {
                final TopologyNode _node177 = currentNode.createNode("instances");
                if (__isIdentity("instances")) {
                    _node177 .setIsIdentity(true);
                }
                if (submitted.contains(list_element.__getNodeId())) {
                    ...
                    _node177 .setTypeHint(cloned.__getNodeName());
                    _node177 .setId(cloned.__getNodeId().toString());
                    cloned.addToNodeTree(_node177, unitService, submitted);
                } else {
                    // Not already submitted, send the entire thing
                    _node177 .setTypeHint(list_element.__getNodeName());
                    _node177 .setId(list_element.__getNodeId().toString());
                    list_element.addToNodeTree(_node177, unitService, submitted);
                }
            }
        }
    }
