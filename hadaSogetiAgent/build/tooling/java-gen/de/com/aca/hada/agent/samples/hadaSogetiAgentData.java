 ...
 * the hadaSogetiAgentData topology object.
 * <p/>
...
public class hadaSogetiAgentData
    extends CollectionModelRoot
{

    public final static String NODE_NAME = "hadaSogetiAgentData";
    ...
    public hadaSogetiAgentData(String name) {
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("hadaSogetiAgentData");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new hadaSogetiAgentData(getName());
    }
