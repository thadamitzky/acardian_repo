 ...
 * the hadaSogetiAgentExampleTopologyType topology object.
 * <p/>
 * This class was generated using version 5.6.10 (5.6.10-201309231246-312109-302) 
 * of the FglAM developer's kit.
 * 
 */
@Generated(value = "FglAM Developer's Kit 5.6.10 (5.6.10-201309231246-312109-302)", date = "2014-03-20T09:19:47+0100")
public class hadaSogetiAgentExampleTopologyType
    extends TopologyObject
{

    public final static String NODE_NAME = "hadaSogetiAgentExampleTopologyType";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;
    private String _name;
    private Agent _monitoringAgent;

    public hadaSogetiAgentExampleTopologyType() {
    }
        ...
        throws TopologyException
    {
        ...
        if (!(_monitoringAgent == null)) {
            final TopologyNode _node9 = currentNode.createNode("monitoringAgent");
            ...
            if (submitted.contains(_monitoringAgent.__getNodeId())) {
                ...
                _node9 .setRefId(_monitoringAgent.__getNodeId().toString());
            } else {
                // Not already submitted, send the entire thing
                _node9 .setTypeHint(_monitoringAgent.__getNodeName());
                _node9 .setId(_monitoringAgent.__getNodeId().toString());
                _monitoringAgent.addToNodeTree(_node9, unitService, submitted);
            }
        }
    }
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("hadaSogetiAgentExampleTopologyType");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new hadaSogetiAgentExampleTopologyType();
    }
