 ...
 * the CollectionModelRoot topology object.
 * <p/>
...
public class CollectionModelRoot
    extends ModelRoot
{

    public final static String NODE_NAME = "CollectionModelRoot";
    ...
    public CollectionModelRoot(String name) {
        if (name == null) {
        ...
        throws TopologyException
    {
        ...
        if (!(_name == null)) {
            final TopologyValue _value29 = currentNode.createValue("name");
            _value29 .setSampleValue(_name.toString());
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new CollectionModelRoot(getName());
    }
