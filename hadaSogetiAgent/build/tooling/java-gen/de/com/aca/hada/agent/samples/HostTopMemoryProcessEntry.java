    ...
    extends HostTopProcessEntry
{
        ...
        throws TopologyException
    {
        ...
        if (!(_residentSetSize == null)) {
            final TopologyValue _value103 = currentNode.createValue("residentSetSize");
            _value103 .setSampleValue(_residentSetSize, unitService.getUnits("kilobyte"));
            if (__isIdentity("residentSetSize")) {
                _value103 .setIsIdentity(true);
            }
        }
        if (!(_virtualSetSize == null)) {
            final TopologyValue _value104 = currentNode.createValue("virtualSetSize");
            _value104 .setSampleValue(_virtualSetSize, unitService.getUnits("kilobyte"));
