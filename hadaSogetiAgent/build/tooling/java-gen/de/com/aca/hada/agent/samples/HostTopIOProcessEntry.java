    ...
    extends HostTopProcessEntry
{
        ...
        throws TopologyException
    {
        ...
        if (!(_ioRate == null)) {
            final TopologyValue _value208 = currentNode.createValue("ioRate");
            _value208 .setSampleValue(_ioRate, unitService.getUnits("byte/second"));
            if (__isIdentity("ioRate")) {
                _value208 .setIsIdentity(true);
            }
        }
    }
