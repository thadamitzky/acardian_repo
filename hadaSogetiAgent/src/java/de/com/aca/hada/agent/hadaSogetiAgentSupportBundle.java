...
/**
 * A class that can contribute information about the hadaSogetiAgent to 
 * any support bundle that is generated.
 */
public class hadaSogetiAgentSupportBundle implements SupportBundleListener2 {

/** A reference to the main agent class so we can collect information from it */
private final hadaSogetiAgentImpl mhadaSogetiAgent;

/**
 * Creates a new support bundle contributer.
 */
public hadaSogetiAgentSupportBundle(hadaSogetiAgentImpl agent) {
    mhadaSogetiAgent = agent;
}
...
public String getSuggestedLocation() { 
    return "hadaSogetiAgent" + File.separator + "info.txt";
}
...
public String getCollectorName() {
    return "hadaSogetiAgent information";
}
...
public void collectText(OutputStream output, SupportBundleLogger logger) throws Exception {
    ...
    out.println("The hadaSogetiAgent has something to say");
    logger.info("The hadaSogetiAgent has something to say in the log file as well");
}
